...
const RULES = [
  ...
  // -ost as a compound tail (salatost, pizzaost). The lookbehind keeps "kost",
  // "post" and "kostyme" out, which a bare "ost" substring would swallow.
  ['Ost', stem('(?<![kp])ost(er|en)?(?![a-zæøå])')],
  ['Ost', stem('ostepop|revetost|smøreost|sm(ø|oe)reost|kremost|fetaost|gulost|hvitost|brunost|pizzaost|ostesaus')],
  ...
  ['Tørrvarer & baking', stem('m(ü|y)sli|musli|frokostblanding|frokostkorn|granola')],
  ...
  ['Drikke', stem('mineralvann|energidrikk|sportsdrikk|eplejuice|appelsinjuice|leskedrikk|alkoholfri')],
